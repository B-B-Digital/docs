---
slug: /pierwsza-publikacja
sidebar_position: 4
title: "Twoja pierwsza zmiana: jak sprawdzić, że wszystko działa"
---
...
flowchart TD
    A[Otrzymujesz dostęp] --> B[Logujesz się]
    B --> C[Wprowadzasz zmianę]
    C --> D[Klikasz Publikuj]
    D --> E[Strona się aktualizuje]
```
