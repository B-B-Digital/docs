...
slug: /usluga
sidebar_position: 11
title: Jak dodać lub zmienić usługę
---
...
Nazwa usługi to jednocześnie tytuł karty na stronie i podstawa adresu jej własnej podstrony — więcej o tym niżej. Krótki opis to jedno, dwa zdania widoczne na karcie usługi, zanim klient w ogóle w nią kliknie: to miejsce na sedno sprawy, nie na pełny opis zabiegu czy usługi prawnej.

## Zdjęcie i ikona

Każda usługa może mieć swoje zdjęcie — zasady wgrywania i kadrowania są takie same jak wszędzie indziej w panelu ([jak wgrywać i kadrować zdjęcia](./jak-wgrywac-i-kadrowac-zdjecia.md)). Oprócz zdjęcia jest też pole na ikonę — tu jednak nie wgrywasz pliku, tylko wpisujesz jeden emoji, np. 🦷 dla usługi stomatologicznej albo ⚖️ dla sprawy sądowej. Taki emoji pojawia się zwykle na karcie usługi jako lekki, dekoracyjny akcent.
...
Każda usługa ma swoją zakładkę SEO, bo skoro ma własną podstronę, warto zadbać o to, jak wygląda w wynikach wyszukiwania — zobacz [jak wypełnić zakładkę SEO](./jak-wypelnic-zakladke-seo.md).

Skoro oferta jest gotowa, warto przedstawić ludzi, którzy ją realizują: [jak dodać lub zmienić członka zespołu](./czlonek-zespolu.md).
