...
slug: /strona-o-nas
sidebar_position: 9
title: Jak edytować stronę O nas
---
...
Główny blok tekstu na tej stronie to miejsce na opowieść o Twojej firmie — misję, historię powstania praktyki, podejście do klientów. Piszesz go w edytorze tekstu, dokładnie tak samo jak w innych miejscach panelu — z pogrubieniami, nagłówkami czy cytatem, jeśli akurat pasują ([jak korzystać z edytora tekstu](./jak-korzystac-z-edytora-tekstu.md)). To pole jest opcjonalne, ale prawnik piszący dwa zdania o tym, dlaczego otworzył własną kancelarię, buduje więcej zaufania niż pusta strona.
...
Ta strona ma też własną zakładkę SEO — zasady są takie same jak wszędzie indziej, opisane w [jak wypełnić zakładkę SEO](./jak-wypelnic-zakladke-seo.md).

Skoro wiesz już, jak opowiedzieć o swojej firmie, dodaj do niej ludzi: [jak dodać lub zmienić członka zespołu](./czlonek-zespolu.md).
